...
def update_worksheet(data, worksheet):
    """
    updates worksheets and adds a new row to the relevant worksheet
    """
    print(f"updating {worksheet} worksheet...\n")
    worksheet_to_update = SHEET.worksheet(worksheet)
    worksheet_to_update.append_row(data)
    print(f"{worksheet} data successfully updated! \n")


def calculate_surplus_data(sales_row):
    """
    calculate surplus data based on stock - sales data.
    """
...
def get_last_sales():
    """
    get five last entries sales from each sandwich and return average sold.
    """
